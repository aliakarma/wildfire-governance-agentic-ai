...
from experiments._viirs_runner import compute_iot_baseline_ld
...
def main(config_path: str, smoke: bool = False) -> None:
    ...
    def run_seed(seed: int):
        ...
        local_checker = GovernanceInvariantChecker()
    ...
    iot_baseline_ld = compute_iot_baseline_ld(viirs_grids)
