...
download-viirs:
	python data/scripts/download_viirs.py --region california --start_date 2020-08-01 --end_date 2020-10-01 --preprocess
	python data/scripts/download_viirs.py --region mediterranean --start_date 2021-08-01 --end_date 2021-09-30 --preprocess
	python data/scripts/download_viirs.py --region australia --start_date 2019-11-01 --end_date 2020-02-28 --preprocess
